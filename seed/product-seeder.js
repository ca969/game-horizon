...
var products = [
  [
    ...
    new Product({
      imagePath: "images/home-page-thumbnails/cyberpunk-2077.png",
  ...
  [
    ...
    new Product({
      imagePath: "images/game-tabs/coming-soon/watch-dogs-legion.png",
  ...
  [
    ...
    new Product({
      imagePath: "images/shop/halo-master-chief.jpg",
    ...
    new Product({
      imagePath: "images/game-tabs/new-and-trending/wolfenstein-young-blood.jpg",
      title: "Wolfenstein Youngblood",
      price: 29.99,
      genre: "Action, FPS",
      platform: ["xbox", "windows", "playstation"],
